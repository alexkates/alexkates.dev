...
export type PostFragment = {
  ...
  content: { __typename?: "Content"; markdown: string; text: string };
  tags?: Array<{ __typename?: "Tag"; name: string; postsCount: number }> | null;
};
...
export type PublicationFragment = {
  ...
  author: { __typename?: "User"; name: string; username: string; profilePicture?: string | null; followersCount: number };
  ogMetaData: { __typename?: "OpenGraphMetaData"; image?: string | null };
  preferences: {
    __typename?: "Preferences";
    logo?: string | null;
    darkMode?: { __typename?: "DarkModePreferences"; logo?: string | null } | null;
    navbarItems: Array<{
      __typename?: "PublicationNavbarItem";
      id: string;
      type: PublicationNavigationType;
...
export type GetAuthorUsernameQueryVariables = Exact<{
  host: Scalars["String"]["input"];
}>;

export type GetAuthorUsernameQuery = {
  __typename?: "Query";
  publication?: { __typename?: "Publication"; id: string; author: { __typename?: "User"; username: string } } | null;
};
...
export type UserQuery = {
  ...
  user?: {
    ...
    bio?: { __typename?: "Content"; markdown: string } | null;
    badges: Array<{ __typename?: "Badge"; id: string; name: string; image: string; dateAssigned?: string | null; description?: string | null }>;
  } | null;
};
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "brief" } },
          {
            ...
            arguments: [{ kind: "Argument", name: { kind: "Name", value: "first" }, value: { kind: "IntValue", value: "0" } }],
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "totalDocuments" } }] },
          },
      ...
      selectionSet: {
        ...
        selections: [
          ...
          },
          {
            ...
            selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "image" } }] },
          },
          {
            kind: "Field",
...
export const GetAuthorUsernameDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAuthorUsername" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            name: { kind: "Name", value: "publication" },
            arguments: [
              { kind: "Argument", name: { kind: "Name", value: "host" }, value: { kind: "Variable", name: { kind: "Name", value: "host" } } },
            ],
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "author" },
                  selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "username" } }] },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<GetAuthorUsernameQuery, GetAuthorUsernameQueryVariables>;
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "FragmentSpread", name: { kind: "Name", value: "Publication" } },
                {
                  ...
                  name: { kind: "Name", value: "post" },
                  arguments: [
                    { kind: "Argument", name: { kind: "Name", value: "slug" }, value: { kind: "Variable", name: { kind: "Name", value: "slug" } } },
                  ],
                  selectionSet: { kind: "SelectionSet", selections: [{ kind: "FragmentSpread", name: { kind: "Name", value: "Post" } }] },
                },
              ],
            },
          },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  { kind: "FragmentSpread", name: { kind: "Name", value: "Post" } },
                                  {
                                    ...
                                    name: { kind: "Name", value: "comments" },
                                    arguments: [
                                      { kind: "Argument", name: { kind: "Name", value: "first" }, value: { kind: "IntValue", value: "0" } },
                                    ],
                                    selectionSet: {
                                      kind: "SelectionSet",
                                      selections: [{ kind: "Field", name: { kind: "Name", value: "totalDocuments" } }],
                                    },
                                  },
                                ],
                              },
                      ...
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "pageInfo" },
                        selectionSet: { kind: "SelectionSet", selections: [{ kind: "FragmentSpread", name: { kind: "Name", value: "PageInfo" } }] },
                      },
                    ],
                  },
                },
...
export const GetPublicationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPublication" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "host" } },
...
} as unknown as DocumentNode<GetPublicationQuery, GetPublicationQueryVariables>;
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "profilePicture" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "stackoverflow" } },
                      { kind: "Field", name: { kind: "Name", value: "linkedin" } },
                ...
                },
                {
                  ...
                  selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "markdown" } }] },
                },
                {
                  kind: "Field",
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "dateAssigned" } },
                      { kind: "Field", name: { kind: "Name", value: "description" } },
                    ],
                  },
                },
